...
-- Add comments
COMMENT ON TABLE bulldog.users IS 'Stores userEntity account information';
COMMENT ON COLUMN bulldog.users.id IS 'Unique identifier for userEntity';
...
COMMENT ON COLUMN bulldog.users.is_active IS 'Whether userEntity account is active';
