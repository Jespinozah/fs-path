...
-- Add comments
COMMENT ON TABLE bulldog.bank_accounts IS 'Bank accounts linked to userEntity accounts';
COMMENT ON COLUMN bulldog.bank_accounts.user_id IS 'Reference to userEntity';
